...
<div class="main-container">
    <div class="xs-pd-20-10 pd-ltr-20">
        ...
        <div class="row pb-10">
            <div class="col-md-8 mb-20">
                <div class="card-box height-100-p pd-20">
                    ...
                    >
                        <div class="h5 mb-md-0">Total Activities</div>
            ...
            <div class="col-md-4 mb-20">
                ...
                <div class="card-box min-height-200px pd-20" data-bgcolor="#265ed7">
                    ...
                    <div class="d-flex justify-content-between align-items-end">
                        <div class="text-white">
                            <div class="font-14">Purchased</div>
            ...
            <div class="col-lg-4 col-md-6 mb-20 ">
                <div class="card-box height-100-p pd-20 min-height-200px">
                    <div class="d-flex justify-content-between pb-10">
                        <div class="h5 mb-0">Top Retailer</div>
                        <div class="dropdown">
                            <a
                        ...
                        <ul>
                            <li class="d-flex align-items-center justify-content-between">
                                <div class="name-avatar d-flex align-items-center pr-2">
                                    <div class="avatar mr-2 flex-shrink-0">
                                        <img
                                            src="{{asset('admin_assets/vendors/images/photo1.jpg')}}"
                            ...
                            <li class="d-flex align-items-center justify-content-between">
                                <div class="name-avatar d-flex align-items-center pr-2">
                                    <div class="avatar mr-2 flex-shrink-0">
                                        <img
                                            src="{{asset('admin_assets/vendors/images/photo2.jpg')}}"
                                            class="border-radius-100 box-shadow"
                                            width="50"
                                            height="50"
                                            alt=""
                            ...
                            <li class="d-flex align-items-center justify-content-between">
                                <div class="name-avatar d-flex align-items-center pr-2">
                                    <div class="avatar mr-2 flex-shrink-0">
                                        <img
                                            src="{{asset('admin_assets/vendors/images/photo3.jpg')}}"
                                            class="border-radius-100 box-shadow"
                                            width="50"
                                            height="50"
                                            alt=""
                            ...
                            <li class="d-flex align-items-center justify-content-between">
                                <div class="name-avatar d-flex align-items-center pr-2">
                                    <div class="avatar mr-2 flex-shrink-0">
                                        <img
                                            src="{{asset('admin_assets/vendors/images/photo4.jpg')}}"
                                            class="border-radius-100 box-shadow"
                                            width="50"
                                            height="50"
                                            alt=""
            ...
            <div class="col-lg-4 col-md-12 mb-20">
                <div class="card-box height-100-p pd-20 min-height-200px">
                    <div class="max-width-300 mx-auto">
                        <img src="{{asset('admin_assets/vendors/images/upgrade.svg')}}" alt="" />
                    </div>
        ...
        <div class="card-box pb-10 mb-10">
            <div class="h5 pd-20 mb-0">Recent User</div>
                    ...
                    <tr>
                        <td class="table-plus">
                            <div class="name-avatar d-flex align-items-center">
                                <div class="avatar mr-2 flex-shrink-0">
                                    <img
                                        src="{{asset('admin_assets/vendors/images/photo5.jpg')}}"
                                        class="border-radius-100 shadow"
                                        width="40"
                                        height="40"
                                        alt=""
                    ...
                    <tr>
                        <td class="table-plus">
                            <div class="name-avatar d-flex align-items-center">
                                <div class="avatar mr-2 flex-shrink-0">
                                    <img
                                        src="{{asset('admin_assets/vendors/images/photo6.jpg')}}"
                                        class="border-radius-100 shadow"
                                        width="40"
                                        height="40"
                                        alt=""
                    ...
                    <tr>
                        <td class="table-plus">
                            <div class="name-avatar d-flex align-items-center">
                                <div class="avatar mr-2 flex-shrink-0">
                                    <img
                                        src="{{asset('admin_assets/vendors/images/photo9.jpg')}}"
                                        class="border-radius-100 shadow"
                                        width="40"
                                        height="40"
                                        alt=""
                    ...
                    <tr>
                        <td class="table-plus">
                            <div class="name-avatar d-flex align-items-center">
                                <div class="avatar mr-2 flex-shrink-0">
                                    <img
                                        src="{{asset('admin_assets/vendors/images/photo8.jpg')}}"
                                        class="border-radius-100 shadow"
                                        width="40"
                                        height="40"
                                        alt=""
        ...
        <div class="row">
            <div class="col-md-4 mb-20">
                <a href="#" class="card-box d-block mx-auto pd-20 text-secondary">
                    <div class="img pb-30">
                        <img src="{{asset('admin_assets/vendors/images/medicine-bro.svg')}}" alt="" />
                    </div>
                    <div class="content">
            ...
            <div class="col-md-4 mb-20">
                <a href="#" class="card-box d-block mx-auto pd-20 text-secondary">
                    <div class="img pb-30">
                        <img src="{{asset('admin_assets/vendors/images/remedy-amico.svg')}}" alt="" />
                    </div>
                    <div class="content">
            ...
            <div class="col-md-4 mb-20">
                <a href="#" class="card-box d-block mx-auto pd-20 text-secondary">
                    <div class="img pb-30">
                        <img src="{{asset('admin_assets/vendors/images/paper-map-cuate.svg')}}" alt="" />
                    </div>
                    <div class="content">
