                                        ...
                                        <li class="widget-categories__item" data-collapse-item>
                                            ...
                                            <div class="widget-categories__container" data-collapse-content>
                                                <ul class="widget-categories__list widget-categories__list--child">
                                                    ...
                                                    <li class="widget-categories__item">
                                                        <a href="" class="widget-categories__link">Switches &
                                                            Relays</a>
                                                    </li>
                                                    <li class="widget-categories__item">
                                        ...
                                        <li class="widget-categories__item" data-collapse-item>
                                            ...
                                            <div class="widget-categories__container" data-collapse-content>
                                                <ul class="widget-categories__list widget-categories__list--child">
                                                    ...
                                                    <li class="widget-categories__item">
                                                        <a href="" class="widget-categories__link">Consoles &
                                                            Organizers</a>
                                                    </li>
                                                    <li class="widget-categories__item">
                                                        <a href="" class="widget-categories__link">Mobile
                                                            Electronics</a>
                                                    </li>
                                                    <li class="widget-categories__item">
                                                        <a href="" class="widget-categories__link">Steering
                                                            Wheels</a>
                                                    </li>
                                                    <li class="widget-categories__item">
                                                        <a href="" class="widget-categories__link">Cargo
                                                            Accessories</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        ...
                                        <li class="widget-categories__item" data-collapse-item>
                                            ...
                                            <div class="widget-categories__container" data-collapse-content>
                                                <ul class="widget-categories__list widget-categories__list--child">
                                                    ...
                                                    <li class="widget-categories__item">
                                                        <a href="" class="widget-categories__link">Cranks &
                                                            Pistons</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        ...
                                        <li class="widget-categories__item" data-collapse-item>
                                            ...
                                            <div class="widget-categories__container" data-collapse-content>
                                                <ul class="widget-categories__list widget-categories__list--child">
                                                    ...
                                                    <li class="widget-categories__item">
                                                        <a href="" class="widget-categories__link">Air
                                                            Suspension</a>
                                                    </li>
                                                    <li class="widget-categories__item">
                                                    ...
                                                    <li class="widget-categories__item">
                                                        <a href="" class="widget-categories__link">Brake Pad
                                                            Sets</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        ...
                                        <div class="product-gallery product-gallery--layout--product-sidebar product__gallery"
                                            ...
                                            <div class="product-gallery__featured">
                                                ...
                                                <div class="">
                                                    <a class="image image--type--product"
                                                        href="{{ asset($data->ItemImageFront->image) }}" target="_blank"
                                                        data-width="100" data-height="100">
                                                        <div class="image__body">
                                                            <img class="image__tag"
                                                                src="{{ optional($data->ItemImageFront)->image ? asset($data->ItemImageFront->image) : asset('admin_assets/no-image.jpg') }}">
                                                        </div>
                                                    </a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="owl-carousel">
                                                <div class="product-gallery__thumbnails-item image image--type--product">
                                                    <div class="image__body">
                                                        <img class="image__tag" src="{{ asset('website//product-2-70x70.jpg')}}" alt="">
                                                    </div>
                                                </div>
                                                <div class="product-gallery__thumbnails-item image image--type--product">
                                                    <div class="image__body">
                                                        <img class="image__tag" src="{{ asset('website//product-1-70x70.jpg')}}" alt="">
                                                    </div>
                                                </div>
                                                <div class="product-gallery__thumbnails-item image image--type--product">
                                                    <div class="image__body">
                                                        <img class="image__tag" src="{{ asset('website//product-3-70x70.jpg')}}" alt="">
                                                    </div>
                                                </div>
                                                <div class="product-gallery__thumbnails-item image image--type--product">
                                                    <div class="image__body">
                                                        <img class="image__tag" src="{{ asset('website//product-4-70x70.jpg')}}" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div> --}}
                                        ...
                                        <div class="product__header">
                                            ...
                                            <div class="product__subtitle">
                                                <div class="product__rating">
                                                    ...
                                                    <div class="product__rating-label"><a href="">3.5 on 7
                                                            reviews</a></div>
                                                </div>
                                        ...
                                        <div class="product__info">
                                            <div class="product__info-card">
                                                    ...
                                                    <div class="product__prices-stock">
                                                        <div class="product__prices">
                                                            ...
                                                            <div class="product__price product__price--current">
                                                                ...
                                                                @if(Auth::check())
                                                                @php
                                                                $comissionrate = $data->unit_price + ($data->unit_price * $organization->commission_rate / 100);
                                                                @endphp
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div
                                                                ...
                                                                <button class="btn btn-primary" id="bulk-order">Bulk
                                                                    Order</button>
                                                ...
                                                <div id="bulkOrderForm" style="display: none;">
                                                    <form action="{{ route('store.qoute') }}" method="POST" enctype="multipart/form-data"
                                                        class="form-inline" style="display: ruby">
                                                        @csrf
                                                        <input type="hidden" name="item_id" value="{{ $data->id }}">
                                                        {{-- <input type="hidden" name="item_id" value="{{ $data->id }}"> --}}

                                                        <div class="form-group mb-2" style="display: contents">
                                                            <label for="quantity">Quantity</label>
                                                            <input type="text" class="form-control qunantityinput" id="staticEmail2"
                                                                value="" placeholder="Quantity" name="quantity">
                                                        </div>
                                                        <div class="form-group mx-sm-3 mb-2"  style="display: contents">
                                                            <label for="custom_price">Custom Price</label>
                                                            <input type="text" class="form-control custominput"
                                                                id="inputPassword2" placeholder="Custom Price" name="custome_price">
                                                        </div>
                                                        <button type="submit" class="btn btn-primary mb-2 buttonhide">Send Quote</button>
                                                    </form>
                                                </div>
                                                ...
                                                <div class="product-tabs__pane" id="product-tab-specification">
                                                    <div class="spec">
                                                        ...
                                                        <div class="spec__disclaimer">
                                                            ...
                                                            country of manufacture and the appearance
                                                                        ...
                                                                        <div class="review">
                                                                            <div class="review__body">
                                                                                ...
                                                                                <div class="review__meta">
                                                                                    ...
                                                                                    <div class="review__date">12 April,
                                                                                        2018</div>
                                                                                </div>
                                                                                <div class="review__rating">
                                                                                    <div class="rating">
                                                        ...
                                                        <div class="product-card__image">
                                                            <div class="image image--type--product">
                                                                <a href="{{ route('product-detail') }}" class="image__body">
                                                                    <img class="image__tag" src="/product-1-245x245.jpg" alt="">
                                                                </a>
                                                            </div>
                                                ...
                                                <div class="block-products-carousel__cell">
                                                    <div class="product-card product-card--layout--grid">
                                                        ...
                                                        <div class="product-card__image">
                                                            <div class="image image--type--product">
                                                                <a href="{{ route('product-detail') }}" class="image__body">
                                                                    <img class="image__tag" src="/product-2-245x245.jpg" alt="">
                                                                </a>
                                                            </div>
                                                            <div class="status-badge status-badge--style--success product-card__fit status-badge--has-icon status-badge--has-text">
                                                                <div class="status-badge__body">
                                                ...
                                                <div class="block-products-carousel__cell">
                                                    <div class="product-card product-card--layout--grid">
                                                        ...
                                                        <div class="product-card__image">
                                                            <div class="image image--type--product">
                                                                <a href="{{ route('product-detail') }}" class="image__body">
                                                                    <img class="image__tag" src="/product-3-245x245.jpg" alt="">
                                                                </a>
                                                            </div>
                                                            <div class="status-badge status-badge--style--success product-card__fit status-badge--has-icon status-badge--has-text">
                                                                <div class="status-badge__body">
                                                ...
                                                <div class="block-products-carousel__cell">
                                                    <div class="product-card product-card--layout--grid">
                                                        ...
                                                        <div class="product-card__image">
                                                            <div class="image image--type--product">
                                                                <a href="{{ route('product-detail') }}" class="image__body">
                                                                    <img class="image__tag" src="/product-4-245x245.jpg" alt="">
                                                                </a>
                                                            </div>
                                                            <div class="status-badge status-badge--style--success product-card__fit status-badge--has-icon status-badge--has-text">
                                                                <div class="status-badge__body">
                                                ...
                                                <div class="block-products-carousel__cell">
                                                    <div class="product-card product-card--layout--grid">
                                                        ...
                                                        <div class="product-card__image">
                                                            <div class="image image--type--product">
                                                                <a href="{{ route('product-detail') }}" class="image__body">
                                                                    <img class="image__tag" src="/product-5-245x245.jpg" alt="">
                                                                </a>
                                                            </div>
                                                            <div class="status-badge status-badge--style--success product-card__fit status-badge--has-icon status-badge--has-text">
                                                                <div class="status-badge__body">
                                                ...
                                                <div class="block-products-carousel__cell">
                                                    <div class="product-card product-card--layout--grid">
                                                        ...
                                                        <div class="product-card__image">
                                                            <div class="image image--type--product">
                                                                <a href="{{ route('product-detail') }}" class="image__body">
                                                                    <img class="image__tag" src="/product-6-245x245.jpg" alt="">
                                                                </a>
                                                            </div>
                                                            <div class="status-badge status-badge--style--success product-card__fit status-badge--has-icon status-badge--has-text">
                                                                <div class="status-badge__body">
                                                        ...
                                                        <div class="product-card__info">
                                                            ...
                                                            <div class="product-card__name">
                                                                <div>
                                                                    <a href="{{ route('product-detail') }}">Motor Oil Level 5</a>
                                                                </div>
                                                            </div>
                                                            <div class="product-card__rating">
                                                                <div class="rating product-card__rating-stars">
                                                ...
                                                <div class="block-products-carousel__cell">
                                                    <div class="product-card product-card--layout--grid">
                                                        ...
                                                        <div class="product-card__image">
                                                            <div class="image image--type--product">
                                                                <a href="{{ route('product-detail') }}" class="image__body">
                                                                    <img class="image__tag" src="/product-7-245x245.jpg" alt="">
                                                                </a>
                                                            </div>
                                                            <div class="status-badge status-badge--style--success product-card__fit status-badge--has-icon status-badge--has-text">
                                                                <div class="status-badge__body">
                                                        ...
                                                        <div class="product-card__info">
                                                            ...
                                                            <div class="product-card__name">
                                                                <div>
                                                                    <a href="{{ route('product-detail') }}">Brandix Engine Block Z4</a>
                                                                </div>
                                                            </div>
                                                            <div class="product-card__rating">
                                                                <div class="rating product-card__rating-stars">
                                                ...
                                                <div class="block-products-carousel__cell">
                                                    <div class="product-card product-card--layout--grid">
                                                        ...
                                                        <div class="product-card__image">
                                                            <div class="image image--type--product">
                                                                <a href="{{ route('product-detail') }}" class="image__body">
                                                                    <img class="image__tag" src="/product-8-245x245.jpg" alt="">
                                                                </a>
                                                            </div>
                                                            <div class="status-badge status-badge--style--success product-card__fit status-badge--has-icon status-badge--has-text">
                                                                <div class="status-badge__body">
                                                        ...
                                                        <div class="product-card__info">
                                                            ...
                                                            <div class="product-card__name">
                                                                <div>
                                                                    <a href="{{ route('product-detail') }}">Brandix Clutch Discs Z175</a>
                                                                </div>
                                                            </div>
                                                            <div class="product-card__rating">
                                                                <div class="rating product-card__rating-stars">
                                                ...
                                                <div class="block-products-carousel__cell">
                                                    <div class="product-card product-card--layout--grid">
                                                        ...
                                                        <div class="product-card__image">
                                                            <div class="image image--type--product">
                                                                <a href="{{ route('product-detail') }}" class="image__body">
                                                                    <img class="image__tag" src="/product-9-245x245.jpg" alt="">
                                                                </a>
                                                            </div>
                                                            <div class="status-badge status-badge--style--success product-card__fit status-badge--has-icon status-badge--has-text">
                                                                <div class="status-badge__body">
                                                        ...
                                                        <div class="product-card__info">
                                                            ...
                                                            <div class="product-card__name">
                                                                <div>
                                                                    <a href="{{ route('product-detail') }}">Brandix Manual Five Speed Gearbox</a>
                                                                </div>
                                                            </div>
                                                            <div class="product-card__rating">
                                                                <div class="rating product-card__rating-stars">
                                                ...
                                                <div class="block-products-carousel__cell">
                                                    <div class="product-card product-card--layout--grid">
                                                        ...
                                                        <div class="product-card__image">
                                                            <div class="image image--type--product">
                                                                <a href="{{ route('product-detail') }}" class="image__body">
                                                                    <img class="image__tag" src="/product-10-245x245.jpg" alt="">
                                                                </a>
                                                            </div>
                                                            <div class="status-badge status-badge--style--success product-card__fit status-badge--has-icon status-badge--has-text">
                                                                <div class="status-badge__body">
                                                        ...
                                                        <div class="product-card__info">
                                                            ...
                                                            <div class="product-card__name">
                                                                <div>
                                                                    <a href="{{ route('product-detail') }}">Set of Car Floor Mats Brandix Z4</a>
                                                                </div>
                                                            </div>
                                                            <div class="product-card__rating">
                                                                <div class="rating product-card__rating-stars">
